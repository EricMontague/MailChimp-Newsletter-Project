...
class ArtistResource(Resource):
    ...
    def get(self, artist_id):
        ...
        if artist is None:
            return {"message": "Artist could not be found"}, HTTPStatusCode.NOT_FOUND
        return self._schema.dump(artist), HTTPStatusCode.OK
    ...
    def put(self, artist_id):
        ...
        db.session.commit()
        return self._schema.dump(artist), HTTPStatusCode.NO_CONTENT
...
class ArtistListResource(Resource):
    ...
    def get(self):
        ...
        return self._schema.dump(artists, many=True), HTTPStatusCode.OK
    ...
    def post(self):
        ...
        db.session.commit()
        return self._schema.dump(artist), HTTPStatusCode.CREATED
